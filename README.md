...
- For more details on how to set-up and use `AI Code Companion` and understand few usee cases please watch the Video:
  [![AI Code Companion: Boosting Productivity with OpenAI APIs in VS Code | Usage Guide and Tutorial Video](./assets-readme/youtube-video-thumbnail.jpg)](https://www.youtube.com/watch?v=wmkSrL484V0)
