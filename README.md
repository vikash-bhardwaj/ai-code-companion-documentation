...
<img src="./assets/extension-loading-state.png" alt="Extension animated loading state for API progress" width="45%" /> <img src="./assets/extension-initial-question.png" alt="Extension usage screenshot" width="45%" /> <img src="./assets/extension-code-question.png" alt="Extension usage screenshot" width="90%" />
